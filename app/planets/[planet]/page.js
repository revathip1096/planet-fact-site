      ...
      <div className="py-20 px-20">
        <div className="flex">
          <div className="w-9/12 flex justify-center items-center">
            ...
            <img src={getSectionImage()} alt={planetData.name} />
          </div>
          <div className="w-3/12 p-4 mt-20 mr-20">
            ...
            <div className="flex flex-col">
              <button className={`bg-[#419DB9] text-[#ffffff] font-bold py-2 px-6 hover:bg-gray-400 mt-[70px] text-left ${activeSection === "overview" ? "bg-gray-400" : ""}`} onClick={() => handleSectionChange("overview")}>
                01 &nbsp;&nbsp;OVERVIEW
              </button>
              <button className={`bg-[#419DB9] text-[#ffffff] font-bold py-2 px-6 hover:bg-gray-400 mt-[10px] text-left ${activeSection === "structure" ? "bg-gray-400" : ""}`} onClick={() => handleSectionChange("structure")}>
                02 &nbsp;&nbsp;INTERNAL STRUCTURE
              </button>
              <button className={`bg-[#419DB9] text-[#ffffff] font-bold py-2 px-6 hover:bg-gray-400 mt-[10px] text-left ${activeSection === "geology" ? "bg-gray-400" : ""}`} onClick={() => handleSectionChange("geology")}>
                03 &nbsp;&nbsp;SURFACE GEOLOGY
              </button>
            </div>
          </div>
